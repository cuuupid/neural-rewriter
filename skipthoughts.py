...
def load_params(path, params):
    ...
    for kk, vv in params.items():
        if kk not in pp:
            ...
            continue
        params[kk] = pp[kk]
    console.info("Parsed params from file")
    return params
